...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.navigationItem setTitle:@"维修订单"];
...
- (void)GetOrderListByNetwork{
    ...
    NSDictionary *paramDict = @{                                @"state":_orderState,
                                @"usrId":@"",
                                @"garageId":@"705a5cc6-cade-49bd-b42f-20e3ff37225b",
                                @"storeId":@"",
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    //确认维修费用
    UIButton *payButton = [[UIButton alloc] initWithFrame:CGRectMake(footerView.frame.size.width-115, footerView.frame.size.height-35, 100, 30)];
    [payButton setBackgroundColor:[UIColor redColor]];
    [payButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [payButton setTitle:@"确认维修费用" forState:UIControlStateNormal];
    [payButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [payButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    //[button addTarget:self action:@selector(button:) forControlEvents:UIControlEventTouchUpInside];
    //更改维修费用维修费用
    UIButton *changeButton = [[UIButton alloc] initWithFrame:CGRectMake(footerView.frame.size.width-115-105, footerView.frame.size.height-35, 100, 30)];
    [changeButton setBackgroundColor:[UIColor redColor]];
    [changeButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
    [changeButton setTitle:@"更改维修费用" forState:UIControlStateNormal];
    [changeButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [changeButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
    //[button addTarget:self action:@selector(button:) forControlEvents:UIControlEventTouchUpInside];
    //确认订单按钮
    UIButton *okButton = [[UIButton alloc] initWithFrame:CGRectMake(footerView.frame.size.width-95, footerView.frame.size.height-35, 80, 30)];
