...
//合作身份者id，以2088开头的16位纯数字（客户给）
#define AliPartnerID @"2088121758191751"

//收款支付宝账号
#define AliSellerID  @"linkcar@cncrm.net"
...
//后台给的接口网址
#define AliNotifyURL @"http://notify.msp.hk/notify.htm"

#define kAliPayURLScheme @"CLWgarage"
